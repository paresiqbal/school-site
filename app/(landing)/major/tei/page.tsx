      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2">
          ...
          <div className="my-8 max-w-none text-sm md:text-base lg:text-lg">
            <p className="text-lg">
              <span className="text-primary">Teknik Elektronika (TEI)</span>{" "}
              adalah program studi yang mempelajari tentang perancangan,
              perakitan, dan perbaikan perangkat elektronik. Program ini
              mengajarkan siswa tentang dasar-dasar elektronika, sirkuit
              listrik, dan komponen elektronik. Selain itu, siswa juga akan
              mempelajari tentang sistem kontrol, pemrograman mikrokontroler,
