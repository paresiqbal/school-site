          ...
          <div className="my-8 max-w-none text-sm md:text-base lg:text-lg">
            <p className="text-lg">
              <span className="text-primary">
                Program Teknik Instalasi Tenaga Listrik (TITL)
              </span>{" "}
              adalah program pendidikan yang mempersiapkan siswa untuk menjadi
              ahli dalam instalasi tenaga listrik. Program ini mengajarkan siswa
              tentang dasar-dasar tenaga listrik, komponen-komponen listrik, dan
