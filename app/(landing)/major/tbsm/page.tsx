        ...
        <div className="lg:col-span-2">
          ...
          <div className="my-8 max-w-none text-sm md:text-base lg:text-lg">
            <p className="text-lg">
              ...
              adalah program keahlian yang mempelajari teknik sepeda motor dan
              bisnisnya. Program ini mempersiapkan siswa untuk menjadi teknisi
              sepeda motor yang handal dan juga wirausahawan yang mampu
              membangun bisnis sepeda motor.
            </p>
          </div>
        </div>
